...
GET /api/entregas-dinero/sede/{sedeId}/total-gastos
  ...
  PROPUESTA:
    - desde: YYYY-MM-DD (OBLIGATORIO)
    - hasta: YYYY-MM-DD (OBLIGATORIO)
    - tipo: String (opcional, filtrar por tipo de gasto)
...
GET /api/gastos-sede
  ACTUAL: Acepta algunos filtros (sedeId, tipo, desde, hasta, aprobado)
  PROPUESTA:
    - sedeId: Integer
    - tipo: String
    - desde: YYYY-MM-DD
    - hasta: YYYY-MM-DD
    - aprobado: Boolean
    - empleadoId: Integer (filtrar por empleado que registró)
    - entregaId: Integer (filtrar por entrega asociada)
    - page: Integer (default: 1)
    - size: Integer (default: 20, máximo: 100)
...
10. ⚠️ GET /api/gastos-sede - Mejorar filtros existentes y agregar paginación

FASE 3 - MEJORAS (Implementar cuando sea posible):
11. 📋 GET /api/productos - Agregar filtros y paginación
12. 📋 GET /api/inventario-completo - Agregar filtros y paginación
13. 📋 GET /api/clientes - Agregar filtros y paginación
14. 📋 GET /api/proveedores - Agregar filtros y paginación
